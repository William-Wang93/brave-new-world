...
export const NODES = [
  { id:"root", label:"Finance Foundation", t:0, b:null, desc:"CPA, credit training, accounting fundamentals, 3-statement modeling. The table stakes.", req:[], xp:15, col:3, row:0,
  ...
  { id:"controllership", label:"Controllership", t:1, b:"control", desc:"Accounting, reporting, compliance, treasury, cash, systems. Owning the numbers.", req:["root"], xp:20, col:0.8, row:1,
  ...
  { id:"fpa", label:"FP&A & Modeling", t:1, b:"control", desc:"Forecasting, scenarios, operating models, variance analysis.", req:["root"], xp:20, col:2.3, row:1,
  ...
  { id:"cap_markets", label:"Capital Markets", t:1, b:"capital", desc:"Debt and equity instruments, leveraged finance, syndication, credit analysis, project finance.", req:["root"], xp:20, col:3.7, row:1,
  ...
  { id:"corp_dev", label:"Corp Dev", t:1, b:"strategy", desc:"M&A process, due diligence, deal structuring, integration. The full deal lifecycle.", req:["root"], xp:20, col:5.2, row:1,
  ...
  { id:"valuation", label:"Valuation", t:2, b:"capital", desc:"DCF, comps, precedents, LBO models, SOTP, real options.", req:["fpa","cap_markets"], xp:16, col:1.5, row:2,
  ...
  { id:"macro", label:"Macro & Cycles", t:2, b:"capital", desc:"Debt cycles, rate transmission, Fed policy, inflation, currency, credit conditions.", req:["fpa","cap_markets"], xp:16, col:3, row:2,
  ...
  { id:"ai_transform", label:"AI & Transformation", t:2, b:"control", desc:"Leading AI-augmented teams, tool selection, workflow redesign, accountability.", req:["controllership","fpa"], xp:16, col:4.5, row:2,
  ...
  { id:"cap_alloc", label:"Capital Allocation", t:3, b:"capital", desc:"Buffett/Singleton/Leonard/Malone. ROIC discipline, opportunity cost thinking.", req:["valuation","macro"], xp:25, col:1, row:3,
  ...
  { id:"performance", label:"Driving Performance", t:3, b:"strategy", desc:"KPIs, unit economics, margin management, operating leverage.", req:["ai_transform","corp_dev"], xp:25, col:2.5, row:3,
  ...
  { id:"stakeholders", label:"Stakeholders", t:3, b:"leadership", desc:"IR, board, lender relationships, CEO partnership, narrative building.", req:["cap_markets","corp_dev"], xp:25, col:4, row:3,
  ...
  { id:"risk_mgmt", label:"Risk Management", t:3, b:"leadership", desc:"Enterprise risk, hedging, derivatives, compliance. When AI gets it wrong, the CFO is still accountable.", req:["macro","controllership"], xp:25, col:5.2, row:3,
  ...
  { id:"cfo", label:"CFO", t:4, b:null, desc:"Talk to investors. Own the numbers. Allocate capital. Manage risk. Drive performance. Be accountable.", req:["cap_alloc","performance","stakeholders","risk_mgmt"], xp:40, col:3, row:4,
